...
이 예제는 잘 작동합니다. 하지만 처리해야 하는 작업이 꽤 많습니다. 자그마치 fibonacci 함수를 453번이나 호출해야 합니다. 자그마치 fibonacci 함수를 453번이나 호출해야 합니다. 여기에서 11번은 직접 호출한 것이고 나머지 442번은 이미 계산한 값들을 다시 계산하기 위해 호출한 횟수입니다. fibonacci 함수에 메모이제이션을 적용하면 작업량을 현저하게 줄일 수 있습니다.
